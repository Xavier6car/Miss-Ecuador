...
export const CANDIDATES_SEED = [
  { number: 1, name: 'Natalia Arízaga', province: 'Azuay', age: 26 },
  { number: 2, name: 'Marilyn Armijos', province: 'Bolívar', age: 21 },
  { number: 3, name: 'Mayté Sánchez', province: 'Cañar', age: 26 },
  { number: 4, name: 'Mayerly Borja', province: 'Carchi', age: 23 },
  { number: 5, name: 'María de los Ángeles Delgado', province: 'Chimborazo', age: 24 },
  { number: 6, name: 'Brianna Tapia', province: 'Comunidad USA', age: 20 },
  { number: 7, name: 'Arianna Ortiz', province: 'Cuenca', age: 19 },
  { number: 8, name: 'Paola Vergara', province: 'El Oro', age: 27 },
  { number: 9, name: 'Margreth Santillán', province: 'Esmeraldas', age: 24 },
  { number: 10, name: 'Valentina Brito', province: 'Galápagos', age: 23 },
